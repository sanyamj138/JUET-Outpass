...
class ParentCurrentActivity : AppCompatActivity() ,IPostAdapter{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_parent_current)
    ...
    override fun onRejectClicked(postId: String) {
        postDao.updateParent(postId,false)
    }
    override fun onApprovedClicked(postId: String) {
        postDao.updateParent(postId,true)
    }
}