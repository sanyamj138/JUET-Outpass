...
class SupreCurrentActivity : AppCompatActivity(),IPostAdapter {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_supre_current)
    ...
    override fun onRejectClicked(postId: String) {
        postDao.updateSupre(postId,false)
    }
    override fun onApprovedClicked(postId: String) {
        postDao.updateSupre(postId,true)
    }
}